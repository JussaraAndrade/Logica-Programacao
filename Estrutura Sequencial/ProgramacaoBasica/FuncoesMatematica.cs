...
{
    /*
        - Variável A recebe a raiz quadrada de x (Ex: A = Math.Sqrt(x);)
        - Variável A recebe o resultado de x elevado a y (Ex: A = Math.Pow(x, y);)
        - Variável A recebe o valor absoluto de x (Ex: A = Math.Abs(x);)
     */
